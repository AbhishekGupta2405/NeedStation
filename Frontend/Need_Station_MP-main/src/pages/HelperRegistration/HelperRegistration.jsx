          ...
          <form className={styles["registration-form"]} onSubmit={handleSubmit}>
            ...
            <div className={styles["form-section"]}>
              ...
              >
                ...
                <option className={styles["option"]} value="verified">
                  Verified
                </option>
            ...
            <div className={styles["form-section"]}>
              ...
              >
                ...
                <option className={styles["option"]} value="elder_care">
                  Elder Care
                </option>
                ...
                <option className={styles["option"]} value="electrician">
                  Electrician
                </option>
                <option className={styles["option"]} value="plumber">
                  Plumber
                </option>
              </select>
